<?php
    ...
    $data_admins = $mysqli->query("SELECT * FROM user WHERE role = 'Admin' AND deleted = 0 ORDER BY id_user ASC");
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="settings/functions/add/add_petugas" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="role" id="role" class="form-control" value="Admin" readonly required>
